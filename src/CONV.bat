...
%MV_PATH% %source_files_path%*.RTF %base_save_path%WRI
...
%MV_PATH% %source_files_path%*.RTF %base_save_path%EPS
...
%MV_PATH% %source_files_path%*.RTF %base_save_path%WPD
...
%MV_PATH% %source_files_path%*.RTF %base_save_path%DOC
...
%MV_PATH% %source_files_path%*.RTF %base_save_path%DOX
...
%MV_PATH% %source_files_path%*.RTF %base_save_path%PAT
...
rem %MV_PATH% %source_files_path%*.RTF %base_save_path%WS
...
%MV_PATH% %source_files_path%*.BMP %base_save_path%CGM
...
%MV_PATH% %source_files_path%*.BMP %base_save_path%PICT
...
%MV_PATH% %source_files_path%*.BMP %base_save_path%MGX
...
%MV_PATH% %source_files_path%*.BMP %base_save_path%PCX
...
%MV_PATH% %source_files_path%*.BMP %base_save_path%TGA
...
%MV_PATH% %source_files_path%*.BMP %base_save_path%DXF
...
%MV_PATH% %source_files_path%*.EX40 %base_save_path%XLS
...
%MV_PATH% %source_files_path%*.EX40 %base_save_path%DAT
...
%MV_PATH% %source_files_path%*.EX40 %base_save_path%DBF
