...
set %MV_PATH%_PATH=%ARCHIVER_PATH%\%MV_PATH%.EXE
...
for %%f in (%files%) do %MV_PATH% %%f.RTF %base_save_path%WRI
...
for %%f in (%files%) do %MV_PATH% %%f.RTF %base_save_path%EPS
...
for %%f in (%files%) do %MV_PATH% %%f.RTF %base_save_path%WPD
...
for %%f in (%files%) do %MV_PATH% %%f.RTF %base_save_path%DOC
...
for %%f in (%files%) do %MV_PATH% %%f.RTF %base_save_path%DOX
...
for %%f in (%files%) do %MV_PATH% %%f.RTF %base_save_path%PAT
...
rem for %%f in (%files%) do %MV_PATH% %%f.RTF %base_save_path%WS
...
for %%f in (%files%) do %MV_PATH% %%f.BMP %base_save_path%CGM
...
for %%f in (%files%) do %MV_PATH% %%f.BMP %base_save_path%PICT
...
for %%f in (%files%) do %MV_PATH% %%f.BMP %base_save_path%MGX
...
for %%f in (%files%) do %MV_PATH% %%f.BMP %base_save_path%PCX
...
for %%f in (%files%) do %MV_PATH% %%f.BMP %base_save_path%TGA
...
for %%f in (%files%) do %MV_PATH% %%f.BMP %base_save_path%DXF
...
for %%f in (%files%) do %MV_PATH% %%f.EX40 %base_save_path%XLS
...
for %%f in (%files%) do %MV_PATH% %%f.EX40 %base_save_path%DAT
...
for %%f in (%files%) do %MV_PATH% %%f.EX40 %base_save_path%DBF
